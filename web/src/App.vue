...
import { Activity, AudioLines, ChevronDown, ChevronRight, Disc3, FolderOpen, Headphones, LayoutGrid, LogOut, Maximize, Music2, Network, Pause, Play, Plus, Power, Presentation, Radio, Search, Settings, Settings2, Square, Users, X, Download, Upload, Undo2, Save } from '@lucide/vue'
...
const revisionText = computed(() => checkpointBusy.value ? 'Saving revision…' : savedRevision.value ? `Revision ${savedRevision.value.revision}${unsaved.value ? ' · Unsaved changes' : ' · Saved'}` : 'Loading revision…')
