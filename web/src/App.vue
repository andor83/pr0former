...
function connect(id: string) {
  ...
  clearTimeout(reconnect); clearInterval(ping); connected.value = false; lastEngineStatus = -Infinity; lastSequence = -1; bestRtt = Infinity; link.reset()
