...
<template>
  <main class="conductor" :class="{ performance }">
    ...
    <aside v-if="performance" class="cue-deck">
      ...
      <button @click="emit('exit')">Exit performance</button>
    </aside>
  </main>
</template>
