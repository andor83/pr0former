...
.drum-pad{aspect-ratio:1;border-radius:50%;background:radial-gradient(circle at 40% 35%,var(--shade),var(--shade-deep) 70%);border:1px solid var(--shade-line);color:var(--well-ink);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;padding:0;touch-action:none;opacity:1;min-width:44px}
.drum-pad span{font-size:8px;letter-spacing:.2px;line-height:1.1;text-align:center}.drum-pad small{font-size:8px;color:var(--well-ink-muted);font-family:monospace}
