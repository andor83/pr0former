  ...
  <section class="ensemble-workspace">
    ...
    <div v-if="selected" class="ensemble-detail">
      ...
      <section v-if="owner" class="ensemble-management invite-management">
        <div class="management-heading"><div><div class="eyebrow">INVITATION LINK</div><h3 aria-label="Invite a New Collaborator">Invite a New Collaborator<HelpNote label="Invite a New Collaborator">Create a single-use link valid for seven days. New users can create an account while joining this project.</HelpNote></h3></div><Link2 :size="20"/></div>
