...
.input-box{display:flex;border:1px solid var(--amber);border-radius:5px;background:var(--control-well);overflow:hidden}.input-box input{border:0;background:transparent;color:var(--control-ink);appearance:textfield;-moz-appearance:textfield}.input-box input::-webkit-inner-spin-button,.input-box input::-webkit-outer-spin-button{appearance:none;margin:0}.steppers{display:flex;flex-direction:column;width:28px;flex-shrink:0}.steppers button{padding:0;min-height:24px;border:0;border-radius:0;background:color-mix(in srgb,var(--amber) 22%,var(--shade));color:var(--control-ink);line-height:1}.steppers button:hover{background:color-mix(in srgb,var(--amber) 36%,var(--shade))}
