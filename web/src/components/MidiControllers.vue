...
<style scoped>
.controllers{position:relative;margin:55px 72px 34px;display:flex;gap:12px;align-items:flex-start}.controller{width:76px;display:flex;flex-direction:column;align-items:center;gap:4px}.gesture{width:72px;min-height:72px;touch-action:none;cursor:ns-resize;border-radius:6px}.gesture.learning{outline:1px solid var(--amber);background:#dfb87916}.gesture.unassigned{opacity:.5;filter:grayscale(1);cursor:pointer}.gesture.unassigned.learning{opacity:1;filter:none}.gesture.locked{opacity:.55;cursor:default}svg{width:72px;height:72px}.track,.fill{fill:none;stroke:color-mix(in srgb,var(--amber) 24%,var(--shade));stroke-width:5;stroke-linecap:round}.fill{stroke:#eda952}circle{fill:var(--shade);stroke:color-mix(in srgb,var(--amber) 45%,var(--shade))}.pointer{stroke:#ffd092;stroke-width:3;stroke-linecap:round}.controller output{color:var(--control-ink);font-variant-numeric:tabular-nums;font-size:12px}.controller small{font-size:8px;color:var(--ink-muted);text-align:center}.fader{position:relative;width:7px;height:130px;margin:10px auto;background:color-mix(in srgb,var(--amber) 24%,var(--shade));border-radius:5px}.fader i{position:absolute;bottom:0;width:100%;background:#eda952;border-radius:5px}.fader b{position:absolute;left:50%;width:30px;height:15px;transform:translate(-50%,50%);border:1px solid #edba77;border-radius:3px;background:color-mix(in srgb,var(--amber) 40%,var(--shade))}.horizontal{flex-direction:column}.horizontal .controller{width:180px;display:grid;grid-template-columns:140px 40px}.horizontal .gesture{width:140px;min-height:32px;cursor:ew-resize}.horizontal .fader{width:120px;height:7px;margin:12px 10px}.horizontal .fader i{height:100%;left:0}.horizontal .fader b{top:50%;width:15px;height:28px;transform:translate(-50%,-50%)}.horizontal small{grid-column:1 / -1}
</style>
