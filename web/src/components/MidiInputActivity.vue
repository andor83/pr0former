...
<style scoped>
.midi-activity{position:relative;margin:55px 72px 34px;padding:10px;min-height:176px;border:1px solid #edaa55;border-radius:7px;background:#141818;color:#ffc078;box-shadow:0 0 10px #edaa5526,inset 0 0 12px #edaa550a;font-variant-numeric:tabular-nums;font-size:11px}.midi-activity header{display:flex;align-items:center;gap:8px;margin-bottom:8px;font-size:11px}.midi-activity small{margin-left:auto;font-size:9px}.activity-light{width:18px;height:18px;flex-shrink:0;border:1px solid #edaa55;border-radius:50%;background:#33291e}.lit .activity-light{background:#ffc078;box-shadow:0 0 10px #edaa5580}.midi-activity table{width:100%;border-collapse:collapse;text-align:left;table-layout:fixed}.midi-activity th{font-size:9px;font-weight:500;border-bottom:1px solid #edaa5540;padding-bottom:5px}.midi-activity td{padding:4px 0;overflow-wrap:anywhere;vertical-align:top}.midi-activity th:first-child{width:26px}.midi-activity th:last-child{width:40px;text-align:right}.midi-activity td:last-child{text-align:right}.midi-activity p{margin-top:12px;font-size:11px}
</style>
