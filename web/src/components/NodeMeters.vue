...
.node-meter-scale{display:flex;flex-direction:column;justify-content:space-between;padding-bottom:24px;font-size:6px;color:#5f7779;font-family:monospace;line-height:1;text-align:right;width:12px}
...
.node-meter-track{position:relative;width:100%;max-width:14px;min-width:6px;height:100%;min-height:0;border:1px solid #34403f;border-radius:3px;background:#0c1213;overflow:hidden;box-shadow:inset 0 0 8px #0008}
...
.node-meter-grid{position:absolute;inset:0;background:repeating-linear-gradient(to top,transparent 0,transparent 5px,#101719 5px,#101719 6px);pointer-events:none}
...
.node-meter-name{font-size:7px;color:#73898c;line-height:10px}
.stale{opacity:.5}.stale .node-meter-readout{color:#73898c}
