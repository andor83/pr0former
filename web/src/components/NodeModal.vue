...
function booleanParameter(p:Parameter){return (props.node.kind==='control_input'&&['hide_chrome','changes_only'].includes(p.id))||(props.node.kind==='js_control'&&p.id==='midi_passthru')||(props.node.kind==='granular_field'&&p.id==='randomize_pitch')}
