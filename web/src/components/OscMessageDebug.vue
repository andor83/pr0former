...
<style scoped>
.osc-debug{padding:14px;background:#141818;color:#ffc078;border:1px solid #edaa55;border-radius:7px;font-size:12px}.osc-debug.compact{margin:55px 72px 34px;min-height:176px;padding:10px;font-size:11px}.osc-debug header{display:flex;justify-content:space-between;gap:10px;margin-bottom:10px}.osc-debug small{font-size:10px}.osc-debug p{font-size:11px;line-height:1.5;margin:12px 0}.osc-history{max-height:220px;overflow:auto}.osc-history table{border-collapse:collapse;width:100%;table-layout:fixed}.osc-history th,.osc-history td{text-align:left;padding:7px 4px;border-bottom:1px solid #edaa5540;overflow-wrap:anywhere;vertical-align:top}.osc-history th{position:sticky;top:0;background:#141818;font-size:10px}.osc-history th:first-child{width:40px}.osc-debug button{min-height:44px;color:#ffc078}
</style>
