...
<style scoped>
.part-player-readout{display:flex;flex-direction:column;gap:5px;padding:10px 12px;border:1px solid var(--shade-line);border-radius:9px;background:var(--shade);font-size:11px;color:var(--well-ink-muted)}
...
output{font-variant-numeric:tabular-nums;font-size:15px;color:var(--well-control-ink)}
</style>
