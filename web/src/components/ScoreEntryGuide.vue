...
<template>
  <article class="help-article score-entry-guide">
    ...
    <section><h2>Select, move and delete</h2>
      ...
      <p>Deleting a selected bar region clears its contents and keeps the bars. To remove bars, use Measure → Add / delete bars. Deleting an accidental, dot, articulation or phrasing mark edits that mark without deleting its note. Ctrl/Cmd-Z undoes an edit.</p>
    </section>
